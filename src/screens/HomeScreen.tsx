...
const FEATURES = [
  {
    icon: "compress",
    label: "บีบอัดไฟล์",
    desc: "ลดขนาดด้วย quality slider พร้อมดูประมาณการก่อน",
    color: "",
  },
  {
    icon: "convert",
    label: "แปลงรูปแบบ",
    desc: "ส่งออกเป็น DOCX · JPG · PNG · TXT · HTML",
    color: "var(--convert)",
  },
  {
    icon: "rotate",
    label: "หมุนหน้า",
    desc: "บังคับทุกหน้าเป็น Portrait หรือ Landscape",
    color: "var(--rotate)",
  },
  {
    icon: "watermark",
    label: "Watermark",
    desc: "ประทับข้อความลงทุกหน้า รองรับภาษาไทย",
    color: "var(--watermark)",
  },
] as const;
      ...
      >
        ...
        >
          <span>
            made by{" "}
            <a
              href="https://kimookpong.github.io/"
              target="_blank"
          ...
          <a
            href="https://github.com/kimookpong/waijaiPDF"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              color: "var(--text2)",
